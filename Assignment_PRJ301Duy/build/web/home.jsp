                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <c:if test="${isLoggedIn}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn btn-outline-primary" href="orderHistory.jsp">Order History</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link position-relative" href="cart.jsp">
                                    ...
                                    <span id="cart-badge" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                                        <%= session.getAttribute("cartSize") != null ? session.getAttribute("cartSize") : 0 %></span>


                                </a>
                            </li>
                            <li class="nav-item"><a class="nav-link text-warning" href="profile.jsp">Hi, ${customer.name}</a></li>
                ...
                fetch('AddToCartServlet', {
                    ...
                    body: new URLSearchParams({'productId': productId})
                        ...
                        .then(cartSize => {
                            ...
                            document.getElementById('cart-badge').textContent = cartSize;
                        })
